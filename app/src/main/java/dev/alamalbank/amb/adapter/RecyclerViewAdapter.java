...
import dev.alamalbank.amb.Util.BuilderManager;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    private ArrayList<String> bundls;

    public RecyclerViewAdapter(ArrayList bundls) {
        this.bundls = bundls;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.text.setText(bundls.get(position));
