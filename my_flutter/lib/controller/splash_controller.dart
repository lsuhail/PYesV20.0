...
import 'package:my_flutter/data/model/response/config_model.dart';
...
class SplashController extends GetxController implements GetxService{
  ...
  Future<Response> getConfigData() async {
   //chanelJava Future<bool> getConfigData() async {
    iniResults = await invokeNativeMethod("initial");
   if(iniResults!=null){
     print("latefSuhail"+iniResults.toString());
     if(iniResults.containsKey("lang")){
     splashRepo.initChanelData(iniResults["lang"]);
   }
