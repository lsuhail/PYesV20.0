...
import 'package:my_flutter/data/model/body/signup_body.dart';
import 'package:my_flutter/data/model/response/response_model.dart';
...
var logInResults;
  Future<Response> login({String code, String phone, String password}) async {
    ...
    logInResults = await invokeNativeMethod("login",password);
    if(logInResults!=null){
      print("latefSuhail"+logInResults.toString());
      /*if(logInResults.containsKey("lang")){
        authRepo.(logInResults["lang"]);
      }*/
